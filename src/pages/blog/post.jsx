...
import BlogPage from '../../components/wrappers/BlogPage'
...
const pageData = {
  pageTitle: 'Alice in wonderland, Chapter 1, Down the Rabbit-Hole',
  nakedPageSlug: 'blog/post',
  pageAbstract:
...
class Page extends React.Component {
  ...
  render() {
    return (
      <BlogPage seoData={seoData} pageData={pageData} {...this.props}>
        <p>
