...
class Page extends React.Component {
  ...
  render() {
    ...
    images1.push({
      data: this.props.data.g11,
      height: this.props.data.g11.childImageSharp.gatsbyImageData.height,
      width: this.props.data.g11.childImageSharp.gatsbyImageData.width,
    })
    images1.push({
      data: this.props.data.g12,
      height: this.props.data.g12.childImageSharp.gatsbyImageData.height,
      width: this.props.data.g12.childImageSharp.gatsbyImageData.width,
    })
    images1.push({
      data: this.props.data.g13,
      height: this.props.data.g13.childImageSharp.gatsbyImageData.height,
      width: this.props.data.g13.childImageSharp.gatsbyImageData.width,
    })

    images2.push({
      data: this.props.data.doc1,
      height: this.props.data.doc1.childImageSharp.gatsbyImageData.height,
      width: this.props.data.doc1.childImageSharp.gatsbyImageData.width,
    })
    images2.push({
      data: this.props.data.doc3,
      height: this.props.data.doc3.childImageSharp.gatsbyImageData.height,
      width: this.props.data.doc3.childImageSharp.gatsbyImageData.width,
    })
            ...
            <Tabs defaultActiveKey="1">
              <TabPane tab={<span>Design</span>} key="1">
                ...
                <p>
                  ...
                  ventilation of patients suffering from various illnesses. The
                  idea was born during the early days of the COVID-19 pandemic.
                </p>
                <p>
                  A team of five experts in different fields collaborated on
                  this project with support from the Pondicherry Institute of
                  Medical Sciences. Difficulties were faced at almost all
                  levels, but primarily getting supplies and precision
                  machining, making the work much harder!
                </p>
                <p>
                  The JASAN team is happy to report that it is collaborating
              ...
              <TabPane tab={<span>Specs</span>} key="2">
                ...
                <p>
                  ...
                  compliance sheet which has information about parameters and
                  features that are required or desirable in a ventilator. We
                  also note the features that we have been able to implement so
                  far.
                </p>
                <p>
                ...
                <p>
                  ...
                  equipment, compatible humidifier and arm holder should be
                ...
                <p>
                  ...
                  <br />
                  &nbsp;•&nbsp;Test lung: 1 (1 for adult and pediatric each)
                  <br />
              ...
              <TabPane tab={<span>Timeline</span>} key="4">
                <Timeline>
                  <Timeline.Item color="#00128B">
                    <p>
                      <strong>
                        Testing and validation underway (month of May, 2021)
                      </strong>
                    </p>
                    <p>
                      The first set of JASAN prototypes are ready and lab
                      testing is underway, and will happen over the next couple
                      of months. It may take at least six more months for mass
                  ...
                  <Timeline.Item color="#ffd700">
                    ...
                    <p>
                      In terms of user interface, a rotary encoder knob with
                      push button is the only user interface available, along
                      with a 4 inch TFT color display. The graphical UI displays
                      important parameters such as pressure and volume curves,
                      peak pressure, breathing rate and PEEP pressure.
                    </p>
                  </Timeline.Item>
                  <Timeline.Item color="#00128B">
                    <p>
                  ...
                  <Timeline.Item color="#00128B">
                    ...
                    <p>
                      A lot of thought went into making the design, attempting
                      to make something as compact as possible while ensuring
                      the features required for a life support system. An AMBU
                      bag is used as the air reservoir which is deflated using a
                      scissor-like mechanical arm powered by a stepper motor.
                      This allow for very high precision while deflating, thus
                      ensuring tidal volume control.
                    </p>
                    <p>
                      Additionally, the team spent time brainstorming on ways to
                      make the device easily cleanable in a hospital
                      environment. The electronics and hardware reside in the
                      top part of the enclosure, and the AMBU bag is suspended
                      below. This unique design differs from all the low cost
                      AMBU bag respirators on the market.
                    </p>
                  </Timeline.Item>
                </Timeline>
              </TabPane>
